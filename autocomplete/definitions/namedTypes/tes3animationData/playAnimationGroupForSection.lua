return {
	type = "method",
	description = [[This method plays an animation group on the provided body section of related actor, invoking the `playGroup` event.]],
	arguments = {
		...
		{ name = "section", type = "tes3.animationBodySection", description = "The body section on which to play the animation. A value from [`tes3.animationBodySection`](https://mwse.github.io/MWSE/references/animation-body-sections/) namespace." },
